...
public class Checkout {
    ...
    public static void main(String[] args) {
        ...
        // create an if statement to see if they want to checkout or enter Staff POS to make changes
        ...
        if(answer == 4) {
            ...
            switch(input) {
                ...
                case 3 -> {
                    System.out.println("Press enter 1 to decrement a book, 2 to decrement a CD, or 3 to decrement a DVD.");
                    input = scnr.nextInt();
                    if (input == 1) {
                        for(int i = 0; i < book.getBookName().size(); i++) {
                            System.out.println("#"+i + " " + book.getBookName(i));
            ...
            if(answer == 1) {
                ...
                for (int i = 0; i < book.getBookName().size(); i++) {
                    if (book.getBookCopies(i) > 0) 
                        System.out.println("#" + (i+1) + ": " + book.getBookName(i) + " by " + book.getAuthorName(i) + " - $ " + book.getBookPrice(i) + " - Copies: " + book.getBookCopies(i));
                    else
                ...
                if (book.getBookCopies(userInput) <= 0) {
                    ...
                    System.out.println("Sorry! We do not have the book you tried to over in stock.\nWould you like to reserve a copy? Input true or false.");
                    
                    inputBool = scnr.nextBoolean();
                    if (inputBool) {
                        book.reserveBook(userInput);
                        book.decrementBook(userInput);
                        System.out.println("Thank you. We have reserved this book for you and will notice you once we have it back in stock.");
                    }
                    else
            ...
            if (answer == 2) {
                ...
                for (int i = 0; i < cd.getCDName().size(); i++) {
                    if (cd.getCDCopies(i) > 0) 
                        System.out.println("#" + (i+1) + ": " + cd.getCDName(i) + " by " + cd.getArtistName(i) + " - $ " + cd.getCDPrice(i) + " - Copies: " + cd.getCDCopies(i));
                    else
                        System.out.println("#" + (i+1) + ": Out of stock.");
                }
                ...
                if (cd.getCDCopies(userInput) <= 0) {
                    // reserve system
                    System.out.println("Sorry! We do not have the CD you tried to over in stock.\nWould you like to reserve a copy? Input true or false.");
                    
                    inputBool = scnr.nextBoolean();
                    if (inputBool) {
                        cd.reserveCD(userInput);
                        cd.decrementCD(userInput);
                        System.out.println("Thank you. We have reserved this CD for you and will notice you once we have it back in stock.");
                    }
                    else
                        System.out.println("Sorry again that we do not currenty have what you are looking for.");
                }
            ...
            if (answer == 3) {
                ...
                for (int i = 0; i < dvd.getDVDName().size(); i++) {
                    if (dvd.getDVDCopies(i) > 0) 
                        System.out.println("#" + (i+1) + ": " + dvd.getDVDName(i) + " by " + dvd.getCompanyName(i) + " - $ " + dvd.getDVDPrice(i) + " - Copies: " + dvd.getDVDCopies(i));
                    else
                        System.out.println("#" + (i+1) + ": Out of stock.");
                }
                ...
                if (dvd.getDVDCopies(userInput) <= 0) {
                    // reserve system
                    System.out.println("Sorry! We do not have the DVD you tried to over in stock.\nWould you like to reserve a copy? Input true or false.");
                    
                    inputBool = scnr.nextBoolean();
                    if (inputBool) {
                        dvd.reserveDVD(userInput);
                        dvd.decrementDVD(userInput);
                        System.out.println("Thank you. We have reserved this DVD for you and will notice you once we have it back in stock.");
                    }
                    else
                        System.out.println("Sorry again that we do not currenty have what you are looking for.");
                }
            ...
            if (inputBool) {
                ...
                if (membership.findMemberID(username) != -1) {
                    ...
                    if (inputBool) {
                        ...
                        scnr.nextLine();
                        username = scnr.nextLine();
                        System.out.println("Would you like a premium membership? The premium membership is a one time fee of $4.99. \nInput true or false.");
